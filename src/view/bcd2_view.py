...
class bcd2view(customtkinter.CTkFrame):
    ...
    def __init__(self, parent):
        ...
        # Title
        self.search_label = customtkinter.CTkLabel(master=self.main_frame, text="BCD2 tools for finding colors")
        ...
        ################################################################################################################
        # creates check boxes
        self.lbl_SelectBotView = customtkinter.CTkLabel(master=self.checkbox_frame, text="Select Bot View")
        ...
        ################################################################################################################
        # H-Min Val Slider
        self.lbl_H_min = customtkinter.CTkLabel(master=self.slider_controls_frame, text="H-min")
        ...
        self.lbl_S_min = customtkinter.CTkLabel(master=self.slider_controls_frame, text="S-min")
        ...
        self.lbl_V_min = customtkinter.CTkLabel(master=self.slider_controls_frame, text="V-min")
        ...
        self.lbl_H_max = customtkinter.CTkLabel(master=self.slider_controls_frame, text="H-max")
        ...
        self.lbl_S_max = customtkinter.CTkLabel(master=self.slider_controls_frame, text="S-max")
        ...
        self.lbl_V_max = customtkinter.CTkLabel(master=self.slider_controls_frame, text="V-max")
        ...
        self.save_color_button = customtkinter.CTkButton(
            master=self.slider_controls_frame, height=64, text="Save Color Proifle", command=self.add_color_to_list
        )
    ...
    def add_color_to_list(self):
        ...
        color_range = (
            f'\t\t"{color_name}": (np.array([{self.H_minval}, {self.S_minval}, {self.V_minval}]), np.array([{self.H_maxval}, {self.S_maxval}, '
            f" {self.V_maxval}])), \n"
        )
